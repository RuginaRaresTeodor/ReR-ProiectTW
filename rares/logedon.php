...
if (isset($_POST['id_adresa']) && $_POST['id_adresa']!="") {
 ...
 $url = "http://localhost:2000/rares/api.php?id_adresa=".$order_id;
 ...
 echo "<table >";
 echo "<tr><td>Domeniu:</td><td>$result->domeniu</td></tr>";
 echo "<tr><td><a href=$result->link>$result->titlu</a></td></tr>";
 echo "</table>";
}*///imi apeleaza rest apiu pentru un id
?>
<?php
// Include config file
